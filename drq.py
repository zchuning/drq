...
class BetterEncoder(Encoder):
    ...
    def __init__(self, obs_shape, feature_dim):
        ...
        self.convs = nn.ModuleList([
            nn.Conv2d(obs_shape[0], self.num_filters[0], 3, stride=2, padding=1),
            nn.Conv2d(self.num_filters[0], self.num_filters[1], 3, stride=2, padding=1),
            nn.Conv2d(self.num_filters[1], self.num_filters[2], 3, stride=2, padding=0),
            nn.Conv2d(self.num_filters[2], self.num_filters[3], 3, stride=2, padding=0)
        ])
